...
class InstanceStateMessageHandler implements MessageHandlerInterface
{
    ...
    public function __invoke(InstanceStateMessage $message)
    {
        ...
        //Problem with instance because when it's an error during exporting, the uuid is a compose value and not only the uuid of the instance. So if it's an error, in all case, we have to return, from the worker
