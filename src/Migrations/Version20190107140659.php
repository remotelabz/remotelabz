 ...
 */
final class Version20190107140659 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE connexion (id INT AUTO_INCREMENT NOT NULL, pod_id INT DEFAULT NULL, network_interface1_id INT NOT NULL, network_interface2_id INT NOT NULL, name VARCHAR(255) NOT NULL, vlan1 INT NOT NULL, vlan2 INT NOT NULL, INDEX IDX_936BF99C8CC63088 (pod_id), UNIQUE INDEX UNIQ_936BF99C967D5FCB (network_interface1_id), UNIQUE INDEX UNIQ_936BF99C84C8F025 (network_interface2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, lab_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_AC74095A628913D5 (lab_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE device (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, brand VARCHAR(255) DEFAULT NULL, model VARCHAR(255) DEFAULT NULL, launch_order INT NOT NULL, launch_script VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
