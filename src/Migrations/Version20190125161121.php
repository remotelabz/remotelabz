 ...
 */
final class Version20190125161121 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE instance (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, activity_id INT NOT NULL, network_id INT NOT NULL, user_network_id INT NOT NULL, process_name VARCHAR(255) NOT NULL, storage_path VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4230B1DEA76ED395 (user_id), INDEX IDX_4230B1DE81C06096 (activity_id), UNIQUE INDEX UNIQ_4230B1DE34128B91 (network_id), UNIQUE INDEX UNIQ_4230B1DE93754D7D (user_network_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE device (id INT AUTO_INCREMENT NOT NULL, operating_system_id INT DEFAULT NULL, control_interface_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, brand VARCHAR(255) DEFAULT NULL, model VARCHAR(255) DEFAULT NULL, launch_order INT NOT NULL, launch_script VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, virtuality INT NOT NULL, INDEX IDX_92FB68EA391D4AD (operating_system_id), UNIQUE INDEX UNIQ_92FB68E584DDA64 (control_interface_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lab (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE activity (id INT AUTO_INCREMENT NOT NULL, lab_id INT NOT NULL, network_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, shared TINYINT(1) NOT NULL,
supervised TINYINT(1) NOT NULL, access_type VARCHAR(3) NOT NULL, INDEX IDX_AC74095A628913D5 (lab_id), UNIQUE INDEX UNIQ_AC74095A34128B91 (network_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE connexion (id INT AUTO_INCREMENT NOT NULL, network_interface1_id INT NOT NULL, network_interface2_id INT NOT NULL, name VARCHAR(255) NOT NULL, vlan1 INT NOT NULL, vlan2 INT NOT NULL,
UNIQUE INDEX UNIQ_936BF99C967D5FCB (network_interface1_id), UNIQUE INDEX UNIQ_936BF99C84C8F025 (network_interface2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE instance DROP FOREIGN KEY FK_4230B1DE34128B91');
        $this->addSql('ALTER TABLE instance DROP FOREIGN KEY FK_4230B1DE93754D7D');
        ...
        $this->addSql('ALTER TABLE instance DROP FOREIGN KEY FK_4230B1DE81C06096');
