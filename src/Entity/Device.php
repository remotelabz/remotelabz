...
class Device implements InstanciableInterface
{
    ...
    #[Serializer\Groups(['api_get_device', 'export_lab', 'sandbox', 'api_get_lab_template'])]
    ...
    #[Serializer\Groups(['api_get_user', 'api_get_lab_instance','api_get_device', 'api_get_lab','sandbox','worker'])]
    #[Assert\Count(
        min: 0
    )]
