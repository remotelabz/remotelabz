 ...
 */
final class Version20220928082119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE device ADD nb_cpu INT NOT NULL');
        $this->addSql('ALTER TABLE device_instance ADD nb_cpu INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE device DROP nb_cpu');
        $this->addSql('ALTER TABLE device_instance DROP nb_cpu');
    }
}
