 ...
 */
final class Version20230913114349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE network_interface CHANGE vlan vlan VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE network_interface CHANGE vlan vlan INT DEFAULT 0 NOT NULL');
    }
}
