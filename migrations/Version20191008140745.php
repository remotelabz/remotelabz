 ...
 */
final class Version20191008140745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE network_interface CHANGE network_settings_id settings_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B3518C3459949888 ON network_interface (settings_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_B3518C3459949888 ON network_interface');
        $this->addSql('ALTER TABLE network_interface CHANGE settings_id network_settings_id INT DEFAULT NULL');
