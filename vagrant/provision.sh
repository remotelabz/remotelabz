...
# Install packages
apt-get update
apt-get install -y curl gnupg php zip unzip php-bcmath php-curl php-mbstring php-mysql php-xdebug php-xml php-zip libxml2-utils git nodejs npm swapspace
# Shibboleth
...
configurable-http-proxy --port 8888 &
# Folders
