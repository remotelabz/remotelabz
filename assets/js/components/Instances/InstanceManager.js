    ...
    return (<>
        ...
        {labInstance ?
            <ListGroup>
                ...
                {labInstance.state === "created" &&
                    <InstanceList instances={labInstance.deviceInstances} labInstance={labInstance} isSandbox={isSandbox} lab={props.lab} onStateUpdate={onInstanceStateUpdate} showControls={isCurrentUserGroupAdmin(viewAs)} viewAs={viewAs} user={props.user}>
                    </InstanceList>
                }
