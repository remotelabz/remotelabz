...
gulp.task('copy', function() {
    ...
    gulp.src(['bower_components/datatables.net-select/js/*.min.js', 'bower_components/datatables.net-select-bs/css/*.min.css', 'bower_components/datatables.net-select-bs/js/*.min.js'])
        .pipe(gulp.dest('vendor/datatables-select'))

    gulp.src(['bower_components/datatables.net-buttons/js/*.min.js', 'bower_components/datatables.net-buttons-bs/css/*.min.css', 'bower_components/datatables.net-buttons-bs/js/*.min.js'])
        .pipe(gulp.dest('vendor/datatables-buttons'))
