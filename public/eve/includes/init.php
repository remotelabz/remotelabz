...
define('BASE_DIR', '/home/toto/public_html/edit_lab');
...
require_once('includes/__interfc.php');
require_once('includes/__lab.php');
require_once('includes/__network.php');
require_once('includes/__node.php');
require_once('includes/__textobject.php');
require_once('includes/__picture.php');
require_once('includes/functions.php');
require_once('includes/messages_en.php');
require_once('includes/Parsedown.php');
if (defined('LOCALE') && is_file('includes/messages_'.LOCALE.'.php')) {
	// Load a custom language
	require_once('includes/messages_'.LOCALE.'.php');
}
