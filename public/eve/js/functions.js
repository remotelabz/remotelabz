...
function cfg_export(node_id) {
    ...
    var url = 'api.php/labs' + lab_filename + '/nodes/' + node_id + '/export';
    var type = 'PUT';
    $.ajax({
        cache: false,
...
function recursive_cfg_export(nodes, i) {
    ...
    if (typeof nodes[Object.keys(nodes)[i]]['path'] === 'undefined') {
        var url = 'api.php/labs' + lab_filename + '/nodes/' + Object.keys(nodes)[i] + '/export';
    } else {
        var url = 'api.php/labs' + lab_filename + '/nodes/' + nodes[Object.keys(nodes)[i]]['path'] + '/export';
    }
    logger(1, 'DEBUG: ' + url);
    var type = 'PUT';
    $.ajax({
...
function deleteNetwork(id) {
    ...
    var type = 'DELETE';
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/networks/' + id;
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
        type: type,
...
function deleteNode(id) {
    ...
    var type = 'DELETE';
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/nodes/' + id;
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
        type: type,
...
function getLabLinks() {
    var lab_filename = $('#lab-viewport').attr('data-path');
    var deferred = $.Deferred();
    var url = 'api.php/labs' + lab_filename + '/links';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function getNetworks(network_id) {
    ...
    var deferred = $.Deferred();
    if (network_id != null) {
        var url = 'api.php/labs' + lab_filename + '/networks/' + network_id;
    } else {
        var url = 'api.php/labs' + lab_filename + '/networks';
    }
    var type = 'GET';
    $.ajax({
        cache: false,
...
function getNodes(node_id) {
    ...
    var lab_filename = $('#lab-viewport').attr('data-path');
    if (node_id != null) {
        var url = 'api.php/labs' + lab_filename + '/nodes/' + node_id;
    } else {
        var url = 'api.php/labs' + lab_filename + '/nodes';
    }
    var type = 'GET';
    $.ajax({
        cache: false,
...
function getNodeConfigs(node_id) {
    ...
    var lab_filename = $('#lab-viewport').attr('data-path');
    if (node_id != null) {
        var url = 'api.php/labs' + lab_filename + '/configs/' + node_id;
    } else {
        var url = 'api.php/labs' + lab_filename + '/configs';
    }
    var type = 'GET';
    $.ajax({
        cache: false,
...
function getNodeInterfaces(node_id) {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/nodes/' + node_id + '/interfaces';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function getPictures(picture_id) {
    ...
    var lab_filename = $('#lab-viewport').attr('data-path');
    if (picture_id != null) {
        var url = 'api.php/labs' + lab_filename + '/pictures/' + picture_id;
    } else {
        var url = 'api.php/labs' + lab_filename + '/pictures';
    }
    var type = 'GET';
    $.ajax({
        cache: false,
...
function getPicturesMapped(picture_id) {
        ...
        var lab_filename = $('#lab-viewport').attr('data-path');
        if (picture_id != null) {
                var url = 'api.php/labs' + lab_filename + '/picturesmapped/' + picture_id;
        } else {
                var url = 'api.php/labs' + lab_filename + '/pictures';
        }
        var type = 'GET';
...
function getTopology() {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/topology';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function getTemplates(template) {
    var deferred = $.Deferred();
    var url = (template == null) ? 'api.php/list/templates/' : 'api.php/list/templates/' + template;
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function getUsers(user) {
    var deferred = $.Deferred();
    if (user != null) {
        var url = 'api.php/users/' + user;
    } else {
        var url = 'api.php/users/';
    }
    var type = 'GET';
    $.ajax({
        cache: false,
...
function moveFolder(folder, path) {
    var deferred = $.Deferred();
    var type = 'PUT';
    var url = 'api.php/folders' + folder;
    var form_data = {};
...
function deletePicture(lab_file, picture_id, cb) {
    ...
    // Delete network
    var url = 'api.php/labs' + lab_file + '/pictures/' + picture_id;
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
        type: 'DELETE',
...
function setNetworkiVisibility(networkId,visibility) {
    ...
    var url = 'api.php/labs' + lab_filename + '/networks/' + networkId;
    var type = 'PUT';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function start(node_id) {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/nodes/' + node_id + '/start';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function recursive_start(nodes, i) {
    ...
    var lab_filename = $('#lab-viewport').attr('data-path');
    if (typeof nodes[Object.keys(nodes)[i]]['path'] === 'undefined') {
        var url = 'api.php/labs' + lab_filename + '/nodes/' + Object.keys(nodes)[i] + '/start';
    } else {
        var url = 'api.php/labs' + lab_filename + '/nodes/' + nodes[Object.keys(nodes)[i]]['path'] + '/start';
    }
    var type = 'GET';
    $.ajax({
        cache: false,
...
function stop(node_id) {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/nodes/' + node_id + '/stop';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function wipe(node_id) {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/nodes/' + node_id + '/wipe';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function printFormNodeConfigs(values, cb) {
    ...
    if ((ROLE == 'admin' || ROLE == 'editor') && LOCK == 0 )
    {
        ...
        var html = new EJS({
            url: 'ejs/locked_node_configs.ejs'
        }).render({
             values: values
        })
    }
...
function saveLab(form) {
    ...
    var url = 'api.php/labs' + lab_filename + '/configs/' + form_data['id'];
    var type = 'PUT';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function getTextObjects() {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/textobjects';
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function getTextObject(id) {
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/textobjects/' + id;
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function createTextObject(newData) {
    var deferred = $.Deferred()
        ...
        , url = 'api.php/labs' + lab_filename + '/textobjects'
        , type = 'POST';
...
function printFormEditCustomShape(id) {
    ...
    getTextObject(id).done(function(res){
        ...
        , bgColor
        , html = new EJS({
            url: 'ejs/form_edit_custom_shape.ejs'
        }).render({
            MESSAGES: MESSAGES,
            id: id
        })
...
function getLogs(file, per_page, search) {
    var deferred = $.Deferred();
    var url = 'api.php/logs/' + file + "/" + per_page + "/" + search;
    var type = 'GET';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
        ...
        dataType: 'json',
        success: function (data) {
            var html = new EJS({url: 'ejs/logs.ejs'}).render({
                "logs": data,
                "per_page": per_page,
                "search": search,
                "file": file
...
function lockLab() {
    ...
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/Lock' ;
    var type = 'PUT';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
...
function unlockLab(){
    ...
    var deferred = $.Deferred();
    var lab_filename = $('#lab-viewport').attr('data-path');
    var url = 'api.php/labs' + lab_filename + '/Unlock' ;
    var type = 'PUT';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
