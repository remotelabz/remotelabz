...
$('body').on('submit', '#form-picture-add', function (e) {
    ...
    // Get action URL
    var url = 'api.php/labs' + lab_file + '/pictures';
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
        type: 'POST',
    ...
    $('#nodesbootdelete').on('click', function (e) {
        ...
        if (isFreeSelectMode) {
            ...
            $.each(window.freeSelectedNodes, function (i, node) {
                ...
                form_data['data'] = '';
                var url = 'api.php/labs' + lab_filename + '/configs/' + node.path;
                var type = 'PUT';
                $.when($.ajax({
                    cache: false,
                    timeout: TIMEOUT,
            ...
            $.when(getNodes(null)).done(function (nodes) {
                ...
                $.each(nodes, function (key, values) {
                    ...
                    form_data['id'] = key;
                    form_data['data'] = '';
                    var url = 'api.php/labs' + lab_filename + '/configs/' + key;
                    var type = 'PUT';
                    $.when($.ajax({
                        cache: false,
                        timeout: TIMEOUT,
...
$(document).on('submit', '#form-lab-add, #form-lab-edit', function (e) {
    ...
    if ($(this).attr('id') == 'form-lab-add') {
        ...
        var url = 'api.php/labs' + form_data['path'];
        var type = 'PUT';
    }
...
$(document).on('submit', '#form-network-add, #form-network-edit', function (e) {
    ...
    if ($(this).attr('id') == 'form-network-add') {
        ...
        var url = 'api.php/labs' + lab_filename + '/networks/' + form_data['id'];
        var type = 'PUT';
    }
...
$(document).on('submit', '#form-node-add, #form-node-edit', function (e) {
    ...
    if ($(this).attr('id') == 'form-node-add') {
        ...
        var url = 'api.php/labs' + lab_filename + '/nodes/' + form_data['id'];
        var type = 'PUT';
    }
...
function submitPictureEdit(picture_id){
    ...
    form_data['custommap']=''
    // Get action URL
    var url = 'api.php/labs' + lab_file + '/pictures/' + picture_id;//form_data['id'];
    $.ajax({
        cache: false,
        timeout: TIMEOUT,
        type: 'PUT',
...
$('body').on('submit', '.custom-shape-form', function (e) {
    ...
    // Get action URL
    var url = 'api.php/labs' + current_lab + '/textobjects';
    var form_data = {};
